...
from apps.imap.serializers import EmailAccountSerializers
from apps.imap.services import IMAPService
...
class EmailViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = EmailAccountSerializers
    ...
    def latest(self, request):
        ...
        try:
            ...
            return Response(
                {"folder": folder, "emails": service.get_latest_emails(folder, limit)}
            )
